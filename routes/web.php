...
Route::get('LMS/Login', 'LMS\LoginController@login')->name('LMS/Login');

Route::get('LMS/Register', 'LMS\LoginController@register')->name('LMS/Register');

Route::get('LMS/ForgotPassword', 'LMS\LoginController@forgot_password')->name('LMS/ForgotPassword');

Route::post('LMS/RequestOTP/Session', 'LMS\LoginController@request_otp_session')->name('LMS/RequestOTP/Session');

Route::get('LMS/RequestOTP', 'LMS\LoginController@request_otp')->name('LMS/RequestOTP');

Route::post('LMS/Verify', 'LMS\LoginController@verify')->name('LMS/Verify');

Route::post('LMS/Register', 'LMS\LoginController@store')->name('LMS/Register');

Route::post('LMS/Login', 'LMS\LoginController@login_attmpt')->name('LMS/Login');


Route::group(['middleware'=>'auth'], function(){
	Route::get('LMS/Dashboard','LMS/DashboardController@index')->name('LMS/Dashboard');
});
